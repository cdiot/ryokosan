...
class ResetPasswordController extends AbstractController
{
    ...
    #[Route(path: [
        ...
        'es' => '/solicitud-reinicio',
        'fr' => '/demande-reinitialisation',
        'it' => '/richiedere-recupero',
    ...
    #[Route(path: [
        ...
        'fr' => '/verifier-email',
        'it' => '/controllare-posta-elettronica',
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        if (null === $token) {
            throw $this->createNotFoundException('exception.no_reset_token');
        }
